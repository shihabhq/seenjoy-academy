...
export const FAQ_ITEMS: FAQItem[] = [
  {
    ...
    answer:
      "Zoom এ লাইভ মাস্টারক্লাস করানো হবে। ক্লাসের রেকর্ডিং লাইভ ক্লাসের পরবর্তী ২ দিন পাওয়া যাবে। তবে লাইভ ক্লাসে অংশগ্রহণ করলে সরাসরি প্র্যাকটিস ও ফিডব্যাক পাওয়ার সুযোগ থাকবে।",
  },
  {
  ...
  },
  {
    ...
    answer:
      "হ্যাঁ। আপনে যেই স্তরেই থাকুন না কেনো এই লাইভ মাস্টারক্লাসের মাধ্যমে আপনি উপকৃত হবেন।",
  },
  {
  ...
  },
  {
    ...
    answer:
      "পেমেন্ট সফল হলে আপনার ইমেইলে একটি ভেরিফিকেশন মেসেজ পাঠানো হবে। ক্লাসের আগের দিন Zoom লিংক পাঠানো হবে।",
  },
];
