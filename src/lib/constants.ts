...
export const CURRICULUM: CurriculumClass[] = [
  {
    ...
    topics: [
      { text: "পাবলিক স্পিকিং কী এবং কেন জরুরি" },
      { text: "স্টেজ ফ্রাইট কোথা থেকে আসে ও কীভাবে দূর করবেন" },
      { text: "কণ্ঠস্বর, ভঙ্গি ও বডি ল্যাঙ্গুয়েজের শক্তি" },
      { text: "বক্তৃতার কাঠামো: শুরু, মধ্য ও শেষ" },
      { text: "লাইভ প্র্যাকটিস সেশন + ফিডব্যাক" },
    ],
  },
  {
    ...
    topics: [
      { text: "গল্প বলার শিল্প — Storytelling Framework" },
      { text: "শ্রোতার সাথে সংযোগ তৈরির ৫টি কৌশল" },
      { text: "ইমপ্রোভাইজড স্পিচ ও Q&A সামলানো" },
      { text: "উপস্থাপনা ও পাবলিক ইমেজ তৈরি" },
      { text: "চূড়ান্ত প্র্যাকটিস ও পরবর্তী পদক্ষেপ" },
    ],
  },
];
